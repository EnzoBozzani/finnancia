		...
		<div className='white-bg'>
			<section className='mx-auto max-w-screen-xl py-12 px-6'>
				...
				<p className='w-auto md:w-[700px] mx-auto text-sm text-neutral-400 text-center mt-2 font-semibold bg-white'>
					Nossos principais recursos que fazem com que você possa ter a experiência ideal enquanto tem o
				...
				<div className='grid grid-cols-1 md:grid-cols-2 mt-8'>
					...
					<FeatureArticle>
						...
						<FeatureArticle.Text>
							Registre finanças individuais com precisão, oferecendo uma análise detalhada e precisa de
							seus hábitos de financeiros para ter uma visão totalmente abrangente.
						</FeatureArticle.Text>
					</FeatureArticle>
					<FeatureArticle>
						<FeatureArticle.Icon>
						...
						<FeatureArticle.Text>
							Navegue entre diferentes planilhas sem esforço, garantindo uma experiência rápida e direta
							para que os usuários possam acessar e gerenciar seus dados financeiros com facilidade.
						</FeatureArticle.Text>
					</FeatureArticle>
					<FeatureArticle>
						<FeatureArticle.Icon>
